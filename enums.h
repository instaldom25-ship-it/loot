...
enum CombatType_t : uint16_t {
	...
	COMBAT_ICEDAMAGE = 1 << 9,        //  DODAJ
	COMBAT_HOLYDAMAGE = 1 << 10,      //  DODAJ
	COMBAT_DEATHDAMAGE = 1 << 11,     //  DODAJ
	COMBAT_COUNT = 14  //  ZMIEÑ Z 10 NA 14
};
...
enum ConditionType_t {
	...
	CONDITION_BLEEDING = 1 << 21,     //  DODAJ
	CONDITION_FREEZING = 1 << 22,     //  DODAJ
	CONDITION_CURSED = 1 << 23,       //  DODAJ
	CONDITION_BLESSED = 1 << 24,      //  DODAJ
};
